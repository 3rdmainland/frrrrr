...
export const STORE_MIN_ORDER_HOUR = typeof process !== 'undefined' && process.env ? process.env['VUE_APP_MIN_FUTURE_ORDER_HOUR'] : '10'
export const STORE_MAX_ORDER_HOUR = typeof process !== 'undefined' && process.env ? process.env['VUE_APP_MAX_FUTURE_ORDER_HOUR'] : '22'
...
export default class BasketService extends Observable {
     ...
     */
    addBasketItem(userProduct: UserProduct) {
