/**
 * menuPack_helpers.ts
 * Helpers to parse and access Krigle MenuPack JSON payloads, including product configuration extraction
 */
 ...
 */
export function pickLabel(map: Record<string,string>): string {
